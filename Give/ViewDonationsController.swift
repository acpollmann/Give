...
class ViewDonationsController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var sing = singleton()
    var donationArray : [Donation] = singleton.sharedInstance.getDonations()
    var cellId = "cellId"
    ...
    fileprivate func setUpTableView() {
        myTableView.frame = CGRect(x: 0, y: 100, width: view.frame.width, height: 260)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let secondViewController = ViewDonationDetailController()
